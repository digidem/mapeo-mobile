// flow-typed signature: 9d2d1875cb06e61f45b2716531f0cd17
// flow-typed version: /react-navigation_v4.x.x/flow_>=v0.104.x
...
declare module "react-navigation" {
  ...
  declare export type NavigationTabProp<+S> = NavigationScreenProp<S> & {
  ...
  declare export var NavigationContext: React$Context<?NavigationScreenProp<
    NavigationState | NavigationRoute
  >>;
  declare export var NavigationProvider: $PropertyType<
    typeof NavigationContext,
    "Provider"
  >;
  declare export var NavigationConsumer: $PropertyType<
    typeof NavigationContext,
    "Consumer"
  >;
  ...
  declare export var ThemeProvider: $PropertyType<
    typeof ThemeContext,
    "Provider"
  >;
  declare export var ThemeConsumer: $PropertyType<
    typeof ThemeContext,
    "Consumer"
  >;
  declare export var ThemeColors: {
    [theme: SupportedThemes]: { [key: string]: string, ... },
    ...
  };
  ...
  >(
    ...
    $Diff<React$ElementConfig<ComponentType>, {| isLandscape: boolean |}>
  >;
