...
import { useMapStyles, DEFAULT_MAP_ID, CUSTOM_MAP_ID } from "./useMapStyles";
...
const fallbackStyleURL = "asset://offline-style.json" as const;
...
type SelectedMapStyle =
  ...
  | {
      styleUrl: typeof fallbackStyleURL;
      status: "success";
